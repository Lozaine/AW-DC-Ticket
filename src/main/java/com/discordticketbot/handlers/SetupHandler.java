...
public class SetupHandler {
    ...
    public void handle(SlashCommandInteractionEvent event) {
        ...
        if (errorLogChannel != null) {
            embed.addField("🚨 Error Log Channel", errorLogChannel.getAsMention(), true);
        } else {
            embed.addField("🚨 Error Log Channel", "Not configured (errors will log to console)", true);
        }

        embed.addField("👥 Support Roles", supportRolesList, false)
