...
public class ButtonListener extends ListenerAdapter {
    ...
    public void onButtonInteraction(ButtonInteractionEvent event) {
        ...
        switch (buttonId) {
            ...
            case "confirm_close_request" -> closeRequestHandler.handleConfirmCloseRequest(event);
            case "deny_close_request" -> closeRequestHandler.handleDenyCloseRequest(event);
        }
    }
}